...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('branch', '0006_auto_20170323_1038'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('unit', '0006_auto_20170323_1038'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifydate', models.DateTimeField(default=datetime.datetime(2017, 3, 23, 10, 38, 37, 556000))),
                ('postdate', models.DateTimeField(default=datetime.datetime(2017, 3, 23, 10, 38, 37, 557000))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', 'Active'), ('I', 'Inactive'), ('C', 'Cancelled'), ('O', 'Posted'), ('P', 'Printed')], default='A', max_length=1)),
                ('enterdate', models.DateTimeField(auto_now_add=True)),
                ('modifydate', models.DateTimeField(default=datetime.datetime(2017, 3, 23, 10, 38, 37, 558000))),
                ('postdate', models.DateTimeField(default=datetime.datetime(2017, 3, 23, 10, 38, 37, 558000))),
                ('isdeleted', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', 'Active'), ('I', 'Inactive'), ('C', 'Cancelled'), ('O', 'Posted'), ('P', 'Printed')], default='A', max_length=1)),
                ('enterdate', models.DateTimeField(auto_now_add=True)),
                ('modifydate', models.DateTimeField(default=datetime.datetime(2017, 3, 23, 10, 38, 37, 552000))),
