...
# initial setup
model_initial = Department
template_initial = 'rep_department/'
title_initial = 'Report - Department'
...
all_header = [["code", "Code"],
              ...
              ["expchartofaccount", "Exp Chart of Account"],
...
xls_sheetname_initial = 'Department'
