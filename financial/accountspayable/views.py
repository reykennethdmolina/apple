    ...
    if request.method == 'POST':
        ...
        if debit_entries:
            ...
            if Vat.objects.get(pk=int(request.POST['vat'])).rate > 0:
                ...
                inputvatentry.debitamount = float(taxable_amount) * (float(Vat.objects.get(pk=int(request.POST['vat']))
                                                                           .rate) / 100)
            ...
            if request.POST['atc']:
                ...
                ewtaxentry.creditamount = float(taxable_amount) * (float(Ataxcode.objects.get(pk=int(request.
                                                                                                     POST['atc']))
                                                                         .rate) / 100)
