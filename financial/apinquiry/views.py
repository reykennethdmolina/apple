...
class GenerateExcel(View):
    def get(self, request):
        ...
        worksheet.write('H4', 'APV Type', bold)
        worksheet.write('I4', 'APV Subtype', bold)
        worksheet.write('J4', 'Reference', bold)
        worksheet.write('K4', 'Branch', bold)
        worksheet.write('L4', 'Bank Account', bold)
        worksheet.write('M4', 'Credit Terms', bold)
        worksheet.write('N4', 'Due Date', bold)
        ...
        worksheet.write('V4', 'Remarks', bold)
        worksheet.merge_range('W4:AG4', 'Subsidiary Ledger', centertext)
        worksheet.write('AI4', 'TIN', bold)
        worksheet.write('AJ4', 'Address', bold)
        worksheet.write('AK4', 'ZIP', bold)
        ...
        for data in list:
            ...
            worksheet.write(row, col + 5, data.apmain.payeecode)
            worksheet.write(row, col + 6, data.apmain.payeename)
            worksheet.write(row, col + 7, data.apmain.aptype.description)
            worksheet.write(row, col + 8, data.apmain.apsubtype.description)
            worksheet.write(row, col + 9, data.apmain.refno)
            if data.apmain.branch:
                worksheet.write(row, col + 10, data.apmain.branch.code)
            if data.apmain.bankaccount:
                worksheet.write(row, col + 11, data.apmain.bankaccount.code)
            if data.apmain.creditterm:
                worksheet.write(row, col + 12, data.apmain.creditterm.description)
            worksheet.write(row, col + 13, data.apmain.duedate)
            worksheet.write(row, col + 14, data.apmain.vatcode)
            worksheet.write(row, col + 15, data.apmain.vatrate)
            if data.apmain.inputvattype:
                worksheet.write(row, col + 16, data.apmain.inputvattype.code)
            worksheet.write(row, col + 17, data.apmain.deferred)
            worksheet.write(row, col + 18, data.apmain.ataxcode)
            worksheet.write(row, col + 19, data.apmain.ataxrate)
            worksheet.write(row, col + 20, data.apmain.status)
            worksheet.write(row, col + 21, data.apmain.remarks)
            ...
            worksheet.write(row, col + 34, data.apmain.payee.tin)
            worksheet.write(row, col + 35, data.apmain.payee.address1 + ' ' + data.apmain.payee.address2 + ' ' + data.apmain.payee.address3)
            worksheet.write(row, col + 36, data.apmain.payee.zipcode)
